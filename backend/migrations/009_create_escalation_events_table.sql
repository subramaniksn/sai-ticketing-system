...
CREATE TABLE IF NOT EXISTS escalation_events (
    ...
    -- Escalation details
    escalated_by INTEGER NOT NULL REFERENCES users(id) ON DELETE SET NULL, -- Engineer or Manager
    ...
    -- Additional tracking
    escalation_reference_number VARCHAR(100), -- External ticket number if applicable
