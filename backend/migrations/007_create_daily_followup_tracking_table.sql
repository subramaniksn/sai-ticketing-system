...
-- Manager can see compliance, missed follow-ups, and send alerts
...
CREATE TABLE IF NOT EXISTS daily_followup_tracking (
    ...
    support_status_update TEXT, -- Brief summary of support progress
...
CREATE TRIGGER followup_timestamp_trigger
